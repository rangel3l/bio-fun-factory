...
export const words: WordDefinition[] = [
  { word: 'SUSTENTAVEL', clue: 'Desenvolvimento que atende às necessidades presentes sem comprometer o futuro', startRow: 7, startCol: 1, direction: 'horizontal', number: 1 },
  ...
  { word: 'AGUA', clue: 'Recurso natural essencial para a vida', startRow: 9, startCol: 3, direction: 'horizontal', number: 5 },
  { word: 'SOLAR', clue: 'Tipo de energia renovável obtida do sol', startRow: 2, startCol: 7, direction: 'vertical', number: 6 },
  { word: 'FLORESTA', clue: 'Ecossistema rico em árvores e biodiversidade', startRow: 11, startCol: 1, direction: 'horizontal', number: 7 },
  ...
  { word: 'ECO', clue: 'Prefixo relacionado ao meio ambiente', startRow: 10, startCol: 0, direction: 'horizontal', number: 11 },
  { word: 'OXIGENIO', clue: 'Gás vital produzido pelas plantas', startRow: 3, startCol: 13, direction: 'vertical', number: 12 },
  { word: 'TERRA', clue: 'Nosso planeta azul', startRow: 13, startCol: 3, direction: 'horizontal', number: 13 },
